...
parser.add_argument("--model", default="./Experiment/Exp-Cont_t_50/model_denoise_100_60_20.pth", type=str, help="model path")
#parser.add_argument("--model", default="SottGan/Experiment/exp8/checkpoint/model_denoise_190_40.pth", type=str, help="model path")
parser.add_argument("--save", default="results_downstream_vessel_seg_Cont_t_50_correct_version_full/complete/", type=str, help="savepath, Default: results")
parser.add_argument("--gpus", default="0", type=str, help="gpu ids")
parser.add_argument("--dataset", default='/home/local/ASUAD/wzhu59/Desktop/Eye Fundus Image Enhancement using Contextual loss/drive/complete_images',type=str)
parser.add_argument("--input",default='/home/local/ASUAD/wzhu59/Desktop/Eye Fundus Image Enhancement using Contextual loss/drive/complete_deg_images',type=str)
